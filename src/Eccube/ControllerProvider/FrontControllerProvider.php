...
class FrontControllerProvider implements ControllerProviderInterface
{
    public function connect(Application $app)
    {
        ...
        $c->match('/block/wp_news', '\Eccube\Controller\Block\WpController::index')->bind('block_wp_news');
        ...
        $c->post('/products/realtime', '\Eccube\Controller\ProductController::realtime')->bind('product_realtime');
        
        $c->match('/category/{main_cate}', '\Eccube\Controller\ProductController::category_main')->bind('category_main')->assert('main_cate', '[^/]+');
        $c->match('/category/{main_cate}/{sub_cate}', '\Eccube\Controller\ProductController::category_sub')->bind('category_sub');
